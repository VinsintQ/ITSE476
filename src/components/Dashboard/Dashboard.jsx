...
const Dashboard = () => {
  return (
    <main>
      ...
      <p>
        Fitness Log is an open source project that allows you to track your
        workouts and fitness goals.
      </p>
      <p>
        We are using GENERAL PUBLIC LICENSE Version 3, 29 June 2007 (
        <a href="https://www.gnu.org/licenses/gpl-3.0.html#license-text">
          GENERAL PUBLIC LICENSE FULL TEXT
        </a>
        )
      </p>
      <h3>Features </h3>
      ...
      <div className="highlights-container">
        <div className="highlight-item">
          ...
          <p>
            December 10 – 12 in Manama. We'll have workshops, discussions and
            lots of fun!
          </p>
        ...
        <div className="highlight-item">
          ...
          <p>
            Fitness Log is about more than software. It’s about people, culture,
            creation, sharing and collaboration.
          </p>
          <a href="#join-today" className="highlight-link">
            <Link to="/Joinus"> Join Us today</Link>
          </a>
        </div>
      </div>
    </main>
